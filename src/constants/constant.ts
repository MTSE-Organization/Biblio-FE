...
export const ORDER_STATUS_WAITING_PAYMENT = 1;
export const ORDER_STATUS_WAITING_CONFIRMATION = 2;
export const ORDER_STATUS_CONFIRMED = 3;
export const ORDER_STATUS_PACKING = 4;
export const ORDER_STATUS_SHIPPING = 5;
export const ORDER_STATUS_COMPLETE = 6;
export const ORDER_STATUS_RECEIVED = 7;
export const ORDER_STATUS_CANCELLED = 8;
export const ORDER_STATUS_REQUEST_REFUND = 9;
export const ORDER_STATUS_REFUNDED = 10;

export const ORDER_DETAIL_STATUS_PLACED = 0;
export const ORDER_DETAIL_STATUS_PAID = 2;
export const ORDER_DETAIL_STATUS_WAITING_CONFIRM = 3;
export const ORDER_DETAIL_STATUS_PACKAGING = 4;
export const ORDER_DETAIL_STATUS_SHIPPING = 5;
export const ORDER_DETAIL_STATUS_DELIVERED = 6;
export const ORDER_DETAIL_STATUS_COMPLETED = 7;
export const ORDER_DETAIL_STATUS_CANCELLED = 8;
